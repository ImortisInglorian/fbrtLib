...
type FB_THREADPROC as function( param as any ptr ) as any ptr
...
declare function fb_ThreadCall 		cdecl ( proc as any ptr, abi as long, stack_size as ssize_t, num_args as long, ... ) as FBTHREAD ptr
...
/'declare function fb_CondCreate 		FBCALL ( ) as FBCOND
...
#ifdef ENABLE_MT
declare sub 	 fb_TlsInit 		cdecl ( )
declare sub 	 fb_TlsExit 		cdecl ( )
#endif

...
declare sub 	  fb_hEnd 					cdecl  ( errlevel as long )
...
declare function fb_hShell 				cdecl  ( program as ubyte ptr ) as long
...
declare function fb_hParseArgs 			cdecl  ( dst as ubyte ptr, src as ubyte const ptr, length as ssize_t ) as long

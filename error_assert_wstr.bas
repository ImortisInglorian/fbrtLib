...
sub fb_AssertW( filename as ubyte ptr, linenum as long, funcname as ubyte ptr, expression as FB_WCHAR ptr )
...
sub fb_AssertWarnW( filename as ubyte ptr, linenum as long, funcname as ubyte ptr, expression as FB_WCHAR ptr )
	dim as ubyte buffer(0 to BUFFER_SIZE - 1)
	hConvToA( @buffer(0), expression )

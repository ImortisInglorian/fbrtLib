...
extern "C"
function fb_DevFileReadEncodWstr( handle as FB_FILE ptr, dst as FB_WCHAR ptr, max_chars as size_t ptr ) as long
    dim as FILE ptr fp
    dim as size_t chars
	...
	if ( chars <> *max_chars ) then
        memset( cast(ubyte ptr, @dst[chars]), 0, (*max_chars - chars) * sizeof( FB_WCHAR ) )
	end if

...
declare sub 	 fb_PrintPadWstrEx   		   ( handle as FB_FILE ptr, mask as long )

declare sub 	 fb_PrintVoid        	FBCALL ( fnum as long, mask as long )
declare sub 	 fb_PrintVoidEx      		   ( handle as FB_FILE ptr, mask as long )
declare sub 	 fb_PrintVoidWstr    	FBCALL ( fnum as long, mask as long )
declare sub 	 fb_PrintVoidWstrEx  		   ( handle as FB_FILE ptr, mask as long )

declare sub 	 fb_PrintBool        	FBCALL ( fnum as long, _val as ubyte, mask as long )
declare sub 	 fb_PrintByte        	FBCALL ( fnum as long, _val as ubyte, mask as long )
declare sub 	 fb_PrintUByte       	FBCALL ( fnum as long, _val as ubyte, mask as long )
...
declare sub 	 fb_LPrintBool       	FBCALL ( fnum as long, _val as ubyte, mask as long )
declare sub 	 fb_LPrintByte       	FBCALL ( fnum as long, _val as ubyte, mask as long )
declare sub 	 fb_LPrintUByte      	FBCALL ( fnum as long, _val as ubyte, mask as long )
...
declare function fb_PringUsingBoolean 	FBCALL ( fnum as long, _val as ubyte, mask as long ) as long
